  ...
  requestProgress(request(options, function(error, response, body) {
    ...
    if (error) {
      error.message = "Error making request.\n" + error.stack + "\n\n" +
        "Please report this full log at https://github.com/rxaviers/cldr-data";
      downloadDfd.reject(error);
      throw error;
    } else if (!response) {
      error = new Error("Something unexpected happened, please report this" +
        "full log at https://github.com/rxaviers/cldr-data");
      downloadDfd.reject(error);
      throw error;
      ...
      error = new Error("Error requesting archive.\n" +
        ...
        "https://github.com/rxaviers/cldr-data");
      downloadDfd.reject(error);
      throw error;
    }
    ...
    require("fs").writeFileSync("/tmp/file.zip", body);
